        ...
        <section className="max-w-7xl mx-auto">
          <div>
            ...
            <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]"> 
              ...
              My technical skills include proficiency in front-end technologies such as HTML, CSS, and JavaScript, as well as expertise in back-end languages like Python, Java, Go, and Node.js. I have experience working with databases such as SQL and NoSQL, and I am comfortable with cloud-based technologies such as AWS and Azure.<br /><br />

              In addition to my technical skills, I pride myself on my ability to collaborate with others and communicate effectively. I believe that teamwork and communication are key to creating successful software solutions.<br /><br />
